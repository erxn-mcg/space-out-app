...
let App = function() {
    ...
    this.renderApp = () => {
        ...
        if (mode === "work") {
            ...
            this.modeText.innerHTML = "Long pause"
    ...
    this.renderSettings = (settings) => {
        ...
        footer.innerHTML = `<strong style={cursor: pointer}>Erin McGurk</strong>`
        footer.addEventListener("click", (e) => {
            shell.openExternal('https://www.buymeacoffee.com/erxn')
        })
